...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [spatial_path_CasADI, spatial_path]  = pathScriptCasADI(w)

    % spatial_path_CasADI.x_p = 40-40*cos(w);
    % spatial_path_CasADI.y_p = 40*sin(w); 
    % spatial_path_CasADI.dx_p_dw = 40*sin(w);
    % spatial_path_CasADI.dy_p_dw = 40*cos(w);
    % spatial_path_CasADI.dx_p_dw2 = 40*cos(w); 
    % spatial_path_CasADI.dy_p_dw2 = -40*sin(w); 
    % spatial_path_CasADI.dx_p_dw3 = -40*sin(w); 
    % spatial_path_CasADI.dy_p_dw3 = -40*cos(w); 
    % spatial_path_CasADI.phi_p = atan2(spatial_path.dy_p_dw(w),spatial_path.dx_p_dw(w)); 
