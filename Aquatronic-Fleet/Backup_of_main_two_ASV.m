...
for i = 1:no_vessels
    ...
    switch i
            case 1
                ...
                % Orientation
                psi0 = 0.2;           % initial heading / yaw angle [rad]
...
for k=1:((Tsim-0)/T_s)
    ...
    for v = 1:no_vessels
        ...
        switch v
            case 1
                tao_i = mLLCs_dis{v}.step(ref, ASVs{v}.observer_obj.getEstimations(), disturbances_mod, T_s);
                ASVs{v}.setTao(tao_i+ tao_e);
            case 2
                tao_i = mLLCs_dis{v}.step(ref, ASVs{v}.observer_obj.getEstimations(), disturbances_mod, T_s);
                ASVs{v}.setTao(tao_i+ tao_e);
        end
...
Figure_Obs(2, hist_X, hist_X_hat, noise, no_items, tm)
